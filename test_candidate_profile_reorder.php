<?php
echo "<h2>Candidate Profile Layout Reorder Test</h2>";
echo "<p>Testing the reordered layout: Candidate Information first, then vote count...</p>";
...
if (file_exists('candidate_profile.php')) {
    ...
    echo "Layout reordered: <strong>Yes</strong><br><br>";
} else {
    echo "<h3>❌ File Status:</h3>";
...
if ($conn) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo "<h3>New Layout Order Applied:</h3>";
        echo "<ul>";
        echo "<li>✅ <strong>1st Section:</strong> Candidate Information (Full Name & Contact)</li>";
        echo "<li>✅ <strong>2nd Section:</strong> Vote Count & Mobile Number Stats</li>";
        echo "<li>✅ <strong>3rd Section:</strong> Vote Button (if applicable)</li>";
        echo "</ul><br>";

        echo "<h3>Preview of New Layout:</h3>";
        echo "<div style='border: 2px solid #e0e0e0; border-radius: 15px; padding: 20px; background: #f8f9fa; margin: 20px 0;'>";

        // Right side content (reordered)
        ...
        echo "<div style='margin-top: 25px; padding-top: 15px;'>";
        ...
        echo "<ul>";
        echo "<li>📋 <strong>Logical Flow:</strong> Information first, then statistics</li>";
        echo "<li>👁️ <strong>Better UX:</strong> Users see candidate details immediately</li>";
        echo "<li>📊 <strong>Clear Hierarchy:</strong> Vote count follows candidate info</li>";
        echo "<li>🎯 <strong>Action Last:</strong> Vote button at the bottom for decision-making</li>";
        echo "</ul><br>";
